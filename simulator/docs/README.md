# The selected chapaters for the ALS-U EPICS tranings

One can check the full training at the [ALS-U EPICS Environment Training](https://jeonglee.pages.als.lbl.gov/epics-trainings)
